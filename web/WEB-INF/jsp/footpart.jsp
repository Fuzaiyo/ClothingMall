...
<section class="e-newsletter-wrap e-newsletter-cloth">
            ...
            <div class="col-12">
                <div class="e-nl-wrap text-center">
                    <span class="e-nl-icon">
                        <svg xmlns:xlink="http://www.w3.org/1999/xlink" width="50px" height="50px"><path
                                fill-rule="evenodd" fill="rgb(96, 186, 190)"
                    ...
                    <h2 class="e-nl-title">联系我们</h2>
                    <p class="e-nl-des">黑龙江大学计软科协web组<br/>梦想的起点</p>
                    <form>
                        <div class="e-nl-box">
                            <input type="text" placeholder="留下您的联系方式...">
                            <a href="javascript:void(0);" class="e-btn newsletter-btn">提交</a>
                        </div>
                    </form>
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <path fill-rule="evenodd" fill="rgb(167, 171, 175)"
                                          d="M19.000,1.893 C18.293,2.214 17.540,2.427 16.755,2.531 C17.563,2.030 18.179,1.246 18.469,0.299 C17.716,0.765 16.885,1.093 15.999,1.277 C15.284,0.487 14.265,-0.001 13.154,-0.001 C10.997,-0.001 9.261,1.813 9.261,4.037 C9.261,4.357 9.287,4.665 9.351,4.957 C6.113,4.794 3.248,3.185 1.323,0.734 C0.987,1.339 0.789,2.030 0.789,2.775 C0.789,4.174 1.484,5.413 2.520,6.131 C1.894,6.118 1.280,5.930 0.760,5.633 C0.760,5.646 0.760,5.662 0.760,5.677 C0.760,7.640 2.110,9.269 3.880,9.645 C3.563,9.734 3.218,9.777 2.859,9.777 C2.610,9.777 2.358,9.763 2.122,9.709 C2.626,11.307 4.059,12.482 5.762,12.521 C4.436,13.595 2.754,14.243 0.932,14.243 C0.613,14.243 0.306,14.228 -0.000,14.187 C1.725,15.340 3.770,15.999 5.975,15.999 C13.143,15.999 17.062,9.845 17.062,4.511 C17.062,4.332 17.056,4.160 17.047,3.989 C17.821,3.421 18.470,2.710 19.000,1.893 Z"/>
                                </svg>
                            </a>
                        </li>
                        <li>
    ...
    <div class="newletter-moving-wrap">
        <ul class="newletter-moving-list">
            <li><img src="${ctx}/assets/images/index1/news_move1.png" alt="image" class="img-fluid"></li>
            <li><img src="${ctx}/assets/images/index1/news_move2.png" alt="image" class="img-fluid"></li>
            <li><img src="${ctx}/assets/images/index1/news_move3.png" alt="image" class="img-fluid"></li>
            <li><img src="${ctx}/assets/images/index1/news_move4.png" alt="image" class="img-fluid"></li>
        </ul>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="e-footer-inner">
                        <a href="${ctx}/clothes/toIndex"><img src="${ctx}/assets/images/index1/logo.png" alt="logo" class="img-fluid"></a>
                        <p class="efoot-about">电子购衣商城 引领潮流 快捷方便</p>
                        <h2 class="efoot-heading">支付方式</h2>
                        <ul class="efoot-payment">
                            <li><img src="${ctx}/assets/images/index1/payment1.png"
                                     alt="payment" class="img-fluid"></li>
                            <li><img src="${ctx}/assets/images/index1/payment2.png"
                                     alt="payment" class="img-fluid"></li>
                            <li><img src="${ctx}/assets/images/index1/payment3.png"
                                     alt="payment" class="img-fluid"></li>
                            <li><img src="${ctx}/assets/images/index1/payment4.png"
                                                                  alt="payment" class="img-fluid"></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="e-footer-inner">
                        <h2 class="efoot-heading">快速导航</h2>
                        <ul class="efoot-list">
                            <li><a href="javascript:void(0);">我们的组织</a></li>
                            <li><a href="javascript:void(0);">关于商城</a></li>
                            <li><a href="javascript:void(0);">最近消息</a></li>
                            <li><a href="javascript:void(0);">关于我们</a></li>
                            <li><a href="javascript:void(0);">更多资讯</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="e-footer-inner">
                        <h2 class="efoot-heading">更多导航</h2>
                        <ul class="efoot-list">
                            <li><a href="${ctx}/clothes/toIndex">主页</a></li>
                            <li><a href="javascript:void(0);">隐私政策</a></li>
                            <li><a href="javascript:void(0);">定制产品</a></li>
                            <li><a href="javascript:void(0);">合作政策</a></li>
                            <li><a href="javascript:void(0);">公司地点</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="e-footer-inner">
                        <h2 class="efoot-heading">页内导航</h2>
                        <ul class="efoot-list">
