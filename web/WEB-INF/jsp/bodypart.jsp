        ...
        <div class="ht-right">
            <div class="ht-right_info">
                <ul class="ht-info-list">
                    ...
                    <li><a href="${pageContext.request.contextPath}/user/toRecharge">充值</a></li>
    ...
    <div class="header-sticky-wrapper">
        ...
        <div class="hs-left">
            <div class="hs-left-logo">
                <a href="${pageContext.request.contextPath}/clothes/toIndex">
            ...
            <div class="nav-items main-menu-wraper">
                <ul class="menu-list d-xl-flex">
                    ...
                    <li class="position-relative">
                        <a href="${ctx}/clothes/toAll ">全部商品</a>
                    ...
                    <li class="position-relative">
                        ...
                        <div class="drop-menu normal-menu">
                            <ul class="sub-menu">
                                <li><a  href="${ctx}/clothes/label?label=男子">男子</a></li>
                                <li><a  href="${ctx}/clothes/label?label=女子">女子</a></li>
                                <li><a  href="${ctx}/clothes/label?label=运动">运动</a></li>
                                <li><a  href="${ctx}/clothes/label?label=休闲">休闲</a></li>
                            </ul>
                        </div>
                    </li>
        ...
        <div class="hs-right">
            <div class="hs-search-cart ">
                <ul class="hs-search-cart-list">
                    <li>
                        <span class="hs-cart-value">点击搜索商品</span>
